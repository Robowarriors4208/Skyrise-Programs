...
#pragma config(Motor,  port1,           leftWheelR,    tmotorVex393_HBridge, openLoop, reversed)
...
#pragma config(Motor,  port4,           leftLift1,     tmotorVex393_MC29, openLoop, reversed)
...
#pragma config(Motor,  port9,           rightLift2,    tmotorVex393_MC29, openLoop)
